...
abstract public class Vehicle : MonoBehaviour{
	...
	protected Vector3 acceleration;//Acceleration and velocity of vehicle
    protected Vector3 velocity;
	protected Vector3 desired;//Desired vector to use in force calculations
    ...
    //Require that children have method to calculate steering 
	...
	protected Vector3 Arrive(Vector3 targetPosition, float arrivalRadius){
        ...
        {
            desired *= Mathf.Sqrt(distSq/arrivalRadius);//Scale force by distance/arrival radius 
        }
	...
	public Vector3 GetWanderPoint(float pointDistance, float pointRadius){
        ...
        wanderPoint.y += Random.Range(-pointRadius/2, pointRadius/2);//y range halved for less vertical motion than horizontal
